...
if(!curl_errno($ch))
{
   ...
   // echo "<BR>==============================================<br>";
    if ($data['Client']['Beneficiaries']['Beneficiary'][0]){
        ...
        $z=-1;
        for($i=0;$i<$c;$i++){
            if ($_REQUEST[cif_im]===$data['Client']['Beneficiaries']['Beneficiary'][$i]['CIF']){
                $z=$i;
                //echo $_REQUEST[cif_im]."==".$data['Client']['Beneficiaries']['Beneficiary'][$i]['CIF']."==>".$i."<BR>";
            }
        }
        ...
        if ($z==-1) {
            ...
            if (trim($data['Client']['Beneficiaries']['Beneficiary'][$z]['Signature'][Binary])!=''){
                $img=$data['Client']['Beneficiaries']['Beneficiary'][$z]['Signature'];
               // echo 'INTRA:'.$z;
