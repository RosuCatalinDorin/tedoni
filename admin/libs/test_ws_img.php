<?php
/*
*  $_REQUEST[cif]=2100368 --cif client
*  $_REQUEST[type]=PJ --tip client
*  $_REQUEST[cif_im]=2100309 -- cif imputernicit
*  $_REQUEST[res]=img/base64 -- tipul raspunsului
*
*/
/*
...
$ch = curl_init();
$url='http://btclient/sites/mainsite/_vti_bin/BT.iQuest.ClientEnrollment/SignatureClient.svc/web/Get'.$_REQUEST[type].'/'.$_REQUEST[cif];
//echo $url;
...
if(!curl_errno($ch))
{
    ...
    // print_r_tree($data);
    // echo "<BR>==============================================<br>";
    if ($data['Client']['Beneficiaries']['Beneficiary'][0]){
        $c=count($data['Client']['Beneficiaries']['Beneficiary']);
        $z=-1;
        for($i=0;$i<$c;$i++){
            if ($_REQUEST[cif_im]==$data['Client']['Beneficiaries']['Beneficiary'][$i]['CIF'])$z=$i;
        }

        $img=$data['Client']['Beneficiaries']['Beneficiary'][$z]['Signature'];
        if ($z==-1) {
        ...
        elseif (trim($data['Client']['Beneficiaries']['Beneficiary'][$z]['Signature'][Binary])!='')
            $img=$data['Client']['Beneficiaries']['Beneficiary'][$z]['Signature'];
        else {
            $img[Binary]='';
            $img[Type]='jpg';
    ...
    elseif ($_REQUEST[cif_im]==$data['Client']['Beneficiaries']['Beneficiary']['CIF'] && trim($data['Client']['Beneficiaries']['Beneficiary']['Signature']['Binary'])!='')
        $img=$data['Client']['Beneficiaries']['Beneficiary']['Signature'];
    else {
        $img[Binary]='';
        $img[Type]='jpg';
    }

    //print_r_tree($data['Client']['Beneficiaries']['Beneficiary']);
    //echo "<BR>==============================================<br>";
} else echo 'Curl error: ' . curl_error($ch);
curl_close($ch); //close curl handle
if (trim($img[Type])!='tif' && trim($img[Type])!='tiff' && trim($img[Type])!='TIF' && trim($img[Type])!='TIFF'){

}
else {
    include 'phMagick.php';
    $fname=rand(10000,100000).time();
    $fs=$fname.".".$img[Type];
    $fd=$fname.".jpg";
    $f=fopen($fs,'x');
    fwrite($f,base64_decode($img[Binary]));
    fclose($f);
    $p = new phmagick($fs, $fd);
    $p->convert();
    unlink($fs);
    $f=fopen($fd,'rb');
    $img[Binary]=base64_encode(fread($f,filesize($fd)));
    fclose($f);
    unlink($fd);

}
echo $_REQEST[res];
if ($_REQUEST[res]=='img'){?><img src="data:image/<?php echo $img[Type]?>;base64,<?php echo $img[Binary]?>" /><?php }
elseif ($_REQUEST[res]=='base64')   echo $img[Binary];
elseif ($_REQUEST[res]=='binary'){
    Header("Content-Type: image/".(strtolower($img[Type])=='jpg'?'pjpeg':$img[Type]));
