...
var XLS_base64 = (function make_b64(){
...
function readSync(blob, options) {
	switch(options !== undefined && options.type !== undefined ? options.type : "base64") {
		...
		case "base64": return parse(s2a(XLS_base64.decode(blob)), options);
...
function parse_xlml(data, opts) {
	...
	switch(opts.type||"base64") {
		case "base64": return parse_xlml_xml(XLS_base64.decode(data), opts);
...
function firstbyte(f,o) {
	switch((o||{}).type || "base64") {
		...
		case 'base64': return XLS_base64.decode(f.substr(0,12)).charCodeAt(0);
...
function xlsread(f, o) {
	...
	switch(firstbyte(f, o)) {
		...
		case 0x09: return parse_xlscfb(s2a(o.type === 'base64' ? XLS_base64.decode(f) : f), o);
